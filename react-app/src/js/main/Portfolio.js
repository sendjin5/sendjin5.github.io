const Portfolio = () => {
  return (
    <>
      <div className="is-preload-0 is-preload-1 is-preload-2">
        <div id="main">
          <header id="header">
            <h1>황교진</h1>
            <p>
          ...
          <section id="thumbnails">
            ...
            <article>
              ...
              <p>
                Nunc egestas congue lorem. Nullam dictum placerat ex sapien
                tortor mattis.
              </p>
            </article>
            <article>
            ...
            <article>
              ...
              <p>
                Vestibulum ante ipsum primis in faucibus orci luctus ac
                tincidunt dolor.
              </p>
            </article>
            <article>
